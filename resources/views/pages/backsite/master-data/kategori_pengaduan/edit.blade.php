                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9 mx-auto">
                          <input type="text" id="name" name="name" class="form-control" placeholder="contoh Kesehatan"
                            value="{{ isset($kategori_pengaduan) ? $kategori_pengaduan->name : '' }}" autocomplete="off"
                            required>
