                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                       <input type="text" id="name" name="name" class="form-control"
                                          placeholder="contoh Kesehatan" value="{{old('name')}}" autocomplete="off"
                                          required>
                        ...
                        <div class="card-body card-dashboard">
                           ...
                           <div class="table-responsive">
                              <table class="table table-striped table-bordered text-inputs-searching default-table">
                                 ...
                                 <tbody>
                                    @forelse($report_categories as $key => $report_category)
                                    <tr data-entry-id="{{ $report_category->id }}">
                                       <td>{{ $report_category->name }}</td>
                                       <td class="text-center">
                                          ...
                                          <div class="btn-group mr-1 mb-1">
                                             ...
                                             <div class="dropdown-menu">
                                                <a href="#mymodal"
                                                   data-remote="{{ route('backsite.kategori_pengaduan.show', $report_category->id) }}"
                                                   data-toggle="modal" data-target="#mymodal"
                                                   data-title="Kategori Pengaduan" class="dropdown-item">
                                                   Show
                                                </a>
                                                <a class="dropdown-item"
                                                   href="{{ route('backsite.kategori_pengaduan.edit', $report_category->id) }}">
                                                   Edit
                                                </a>
