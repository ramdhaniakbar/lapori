   ...
   <form action="{{ route('lapor.update', $lapor->id) }}" method="POST" enctype="multipart/form-data"
      ...
      <div class="flex space-x-5 mb-10">
         <div class="flex flex-col w-full space-y-2">
            ...
            <input type="text" id="title_report" name="title_report" value="{{ $lapor->title_report }}"
         ...
         <div class="flex flex-col w-full space-y-2">
            ...
            <select name="report_category_id" id="report_category_id"
               ...
               <option value="{{ $report_category->id }}" @if ($report_category->id == $lapor->report_category_id)
                  selected
                  @endif
                  >
      ...
      <div class="flex space-x-5 mb-10">
         <div class="flex flex-col w-full space-y-2">
            ...
            <input type="date" id="incident_date" name="incident_date" value="{{ $lapor->incident_date }}"
         ...
         <div class="flex flex-col w-full space-y-2">
            ...
            <input type="text" id="location_incident" name="location_incident" value="{{ $lapor->location_incident }}"
      ...
      <div class="flex flex-col w-full space-y-2 mb-10">
         ...
         <input type="file" id="report_image" name="report_image" value="{{ $lapor->report_image }}"
      ...
      <div class="flex space-x-5 mb-10">
         <div class="flex flex-col w-full space-y-2">
            ...
            <textarea name="body_report" id="body_report" cols="30" rows="10"
               class="w-full py-3.5 px-[20px] border-[1.5px] border-input-color focus:outline-dark-gray rounded-xl @error('body_report') border-red-color @enderror">{{ $lapor->body_report }}</textarea>
