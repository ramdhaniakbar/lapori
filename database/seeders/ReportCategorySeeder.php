...
class ReportCategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $report_category = [
            ...
            [
                'name' => 'Pembangunan Desa, Daerah Tertinggal, dan Termigrasi',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
            ...
            [
                'name' => 'Kekerasan di Satuan Pendidikan (Sekolah, Kampus, Lembaga Kursus)',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
        ...
        ReportCategory::insert($report_category);
    }
}
